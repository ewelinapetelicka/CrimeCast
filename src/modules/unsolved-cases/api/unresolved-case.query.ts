...
export const useGetUnsolvedCasesList = () =>
  useQuery({
...
export const useGetUnsolvedCaseDetails = (id: string) =>
  useQuery({
...
export const usePostUnresolvedCase = () =>
  useMutation({
    mutationKey: [UNRESOLVED_CASES_KEY],
    mutationFn: (unsolvedCase: UnsolvedCaseDTO) =>

...
export function Pagination(props: PaginationProps) {
    return (
        <div className={"flex  w-full justify-center items-center gap-3 pb-3"}>
            <button
                className={"bg-white bg-opacity-20 p-2 rounded-2xl shadow-inner shadow-neutral-50 text-amber-50"}
                onClick={() => props.prev()} disabled={props.disabledPrev}>previous page
            </button>
            <p className={"bg-white bg-opacity-20 p-2 rounded-2xl shadow-inner shadow-neutral-50 text-amber-50"}>
